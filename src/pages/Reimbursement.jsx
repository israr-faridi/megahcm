...
// Images
import ServiceHero from '../assets/images/reimbursement1.webp'
import Blank1 from "../assets/images/attendance2.webp"
import Blank2 from "../assets/images/reimbursement3.webp"
import MobileImg from "../assets/images/reimbursement4.webp"

const Reimbursement = ({ onOpenModal }) => {
  // section1
  const sec1Data = [{
  ...
  return (
    <>
      <Seo title="Reimbursement" description="Welcome to Reimbursementpage" />
            ...
            <div className="row g-4">
              <div className="col-12 col-md-12 col-lg-6">
                <div className="heroDataLeft">
                  <h1>Reimbursement Management <span>Empowering Workforce</span></h1>

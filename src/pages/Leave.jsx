...
// Images
import ServiceHero from '../assets/images/leave1.webp'
import Blank1 from "../assets/images/attendance2.webp"
import Blank2 from "../assets/images/leave3.webp"
import MobileImg from "../assets/images/leave4.webp"
const Leave = ({onOpenModal}) => {
  // section1
  const sec1Data = [{
  ...
  return (
    <>
      <Seo title="Leave" description="Welcome to Leavepage" />
            ...
            <div className="row g-4">
              <div className="col-12 col-md-12 col-lg-6">
                <div className="heroDataLeft">
                  <h1>Accurate Leave Management <span>Empowering Workforce</span></h1>

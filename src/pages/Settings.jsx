...
// Images
import ServiceHero from '../assets/images/settings1.webp'
import Blank1 from "../assets/images/attendance2.webp"
import Blank2 from "../assets/images/settings3.webp"
import MobileImg from "../assets/images/settings4.webp"


const Settings = ({ onOpenModal }) => {
  // section1
  const sec1Data = [{
            ...
            <div className="row g-4">
              <div className="col-12 col-md-12 col-lg-6">
                <div className="heroDataLeft">
                  <h1>Accurate Settings Management <span>Empowering Workforce</span></h1>

...
// Images
import ServiceHero from '../assets/images/payroll1.webp'
import Blank1 from "../assets/images/attendance2.webp"
import Blank2 from "../assets/images/payroll3.webp"
import MobileImg from "../assets/images/payroll4.webp"

const Payroll = ({ onOpenModal }) => {
  // section1
  const sec1Data = [{
  ...
  return (
    <>
      <Seo title="Payroll" description="Welcome to Payrollpage" />
            ...
            <div className="row g-4">
              <div className="col-12 col-md-12 col-lg-6">
                <div className="heroDataLeft">
                  <h1>Accurate Payroll Management <span>Empowering Workforce</span></h1>

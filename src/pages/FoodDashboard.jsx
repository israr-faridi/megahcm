...
// Images
import ServiceHero from '../assets/images/food-dashboard1.webp'
import Blank1 from "../assets/images/attendance2.webp"
import Blank2 from "../assets/images/food-dashboard3.webp"
import MobileImg from "../assets/images/food-dashboard4.webp"


const FoodDashboard = ({ onOpenModal }) => {
  // section1
  const sec1Data = [{
  ...
  return (
    <>
      <Seo title="Food Dashboard" description="Welcome to Food Dashboardspage" />
            ...
            <div className="row g-4">
              <div className="col-12 col-md-12 col-lg-6">
                <div className="heroDataLeft">
                  <h1>Food Dashboard Management <span>Empowering Workforce</span></h1>
